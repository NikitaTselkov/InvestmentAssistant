        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 6, "Показывает, сколько прибылей до уплаты процентов, налогов и амортизации должна заработать компания, чтобы окупить реальную рыночную цену компании.", "EV/EBITDA" },
                    { 7, "Сообщает о достаточности или нехватке ресурсов для погашения займов и процентных ставок по ним.", "DEBT/EBITDA" },
